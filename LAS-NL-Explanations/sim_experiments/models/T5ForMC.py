...
class T5ModelForMC(T5PreTrainedModel):
    ...
    def forward(self, reduce_batch = True, loss_weights = None, reduce_loss=None, **kwargs):
        ...
        if encoder_hidden_states is None:
            ...
            encoder_outputs = self.encoder(inputs_embeds=hidden_states, **kwargs_encoder)
        ...
        # print(type(encoder_hidden_states), len(encoder_hidden_states))

        kwargs_decoder["encoder_hidden_states"] = encoder_hidden_states
        kwargs_decoder["encoder_attention_mask"] = kwargs_encoder.get("attention_mask", None)
        decoder_outputs = self.decoder(inputs_embeds=hidden_states, **kwargs_decoder)
